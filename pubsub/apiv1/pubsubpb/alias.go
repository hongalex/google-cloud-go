...
// SubscriberClient is the client API for Subscriber service. For
// semantics around ctx use and closing/ending streaming RPCs, please refer to
// https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
//
// Deprecated: Please use types in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
type SubscriberClient = src.SubscriptionAdminClient

// SubscriptionAdminServer is the server API for Subscriber service.
//
// Deprecated: Please use types in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
type SubscriberServer = src.SubscriptionAdminServer
type Subscriber_StreamingPullClient = src.SubscriptionAdmin_StreamingPullClient
type Subscriber_StreamingPullServer = src.SubscriptionAdmin_StreamingPullServer
...
// TopicAdminClient is the client API for Publisher service. For semantics
// around ctx use and closing/ending streaming RPCs, please refer to
// https://godoc.org/google.golang.org/grpc#ClientConn.NewStream.
//
// Deprecated: Please use types in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
type PublisherClient = src.TopicAdminClient

// TopicAdminServer is the server API for Publisher service.
//
// Deprecated: Please use types in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
type PublisherServer = src.TopicAdminServer
...
// UnimplementedSubscriptionAdminServer can be embedded to have forward
// compatible implementations.
//
// Deprecated: Please use types in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
type UnimplementedSubscriptionAdminServer = src.UnimplementedSubscriptionAdminServer

// UnimplementedTopicAdminServer can be embedded to have forward compatible
// implementations.
//
// Deprecated: Please use types in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
type UnimplementedTopicAdminServer = src.UnimplementedTopicAdminServer
...
func NewSubscriberClient(cc grpc.ClientConnInterface) SubscriberClient {
	return src.NewSubscriptionAdminClient(cc)
}

// Deprecated: Please use funcs in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
func NewPublisherClient (cc grpc.ClientConnInterface) PublisherClient {
	return src.NewTopicAdminClient(cc)
}
...
func RegisterSubscriberServer(s *grpc.Server, srv SubscriberServer) {
	src.RegisterSubscriptionAdminServer(s, srv)
}

// Deprecated: Please use funcs in: cloud.google.com/go/pubsub/v2/apiv1/pubsubpb
func RegisterPublisherServer(s *grpc.Server, srv PublisherServer) {
	src.RegisterTopicAdminServer(s, srv)
}
